...
public class PerformanceStatisticTest {
	...
	public void before() {
		...
		stats1 = new PerformanceStatistic("Stats 1", p1);
	}

	@Test
	public final void testPerformanceStatistic() {
		...
		p3.getZone(stz2).occupy();
		stats1.updateStatistics(e1, p1);
		assertEquals(8.8, stats1.getOccupancy(), .5);
		assertEquals(19, stats1.getProfits(), .5);
	}

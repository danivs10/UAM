...
class Book(models.Model):
    ...
    # Foreign Key used because book can only
    # have one author, but authors can have multiple books
    # Author as a string rather than
    ...
    # Genre class has already been defined so
    # we can specify the object above.
...
class BookInstance(models.Model):
    ...
    copy of a book (i.e. that can be borrowed from the library)."""
    id = models.UUIDField(primary_key=True,
                          default=uuid.uuid4,
                          help_text='Unique \
    ID for this particular book across whole library')

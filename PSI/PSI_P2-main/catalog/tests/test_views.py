...
class AuthorCreateViewTest(TestCase):
    def setUp(self):
        ...
        author = Author.objects.create(first_name='Pepe', last_name='Lagartija')
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        expected_date = datetime.date(2020, 6, 11)
        real_date = datetime.datetime.strptime(response.context['form'].initial['date_of_death'], "%d/%m/%Y").date()
        self.assertEqual(real_date, expected_date)
        
    def test_redirects_to_detail_view_on_success(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'), {'first_name': 'Guillermo', 'last_name': 'Martin-coello', 'date_of_birth': '01/10/2020'})
        self.assertEqual(response.status_code, 200)

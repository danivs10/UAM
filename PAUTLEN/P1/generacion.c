...
{
    if (fpasm == NULL || nombre == NULL || tamano < 0 || tipo < 0 || tipo > 1)
        return;
...
void igual(FILE *fpasm, int es_variable1, int es_variable2, int etiqueta)
{
    ...
    fprintf(fpasm, "\n\tcmp eax, ebx");
    fprintf(fpasm, "\n\tjz near is_equal_%d", etiqueta);

    fprintf(fpasm, "\n\tmov dword eax, 0");
    fprintf(fpasm, "\n\tpush dword eax");
    fprintf(fpasm, "\n\tjmp near next_is_equal_%d", etiqueta);

    fprintf(fpasm, "\nis_equal_%d:", etiqueta);
    fprintf(fpasm, "\n\tmov dword eax,1");
    fprintf(fpasm, "\n\tpush dword eax");

    fprintf(fpasm, "\nnext_is_equal_%d:", etiqueta);
}
...
void distinto(FILE *fpasm, int es_variable1, int es_variable2, int etiqueta)
{
    ...
    fprintf(fpasm, "\n\tcmp eax, ebx");
    fprintf(fpasm, "\n\tjnz near is_not_equal_%d", etiqueta);

    fprintf(fpasm, "\n\tmov dword eax, 0");
    fprintf(fpasm, "\n\tpush dword eax");
    fprintf(fpasm, "\n\tjmp near next_is_not_equal_%d", etiqueta);

    fprintf(fpasm, "\nis_not_equal_%d:", etiqueta);
    fprintf(fpasm, "\n\tmov dword eax,1");
    fprintf(fpasm, "\n\tpush dword eax");

    fprintf(fpasm, "\nnext_is_not_equal_%d:", etiqueta);
}
...
void menor_igual(FILE *fpasm, int es_variable1, int es_variable2, int etiqueta)
{
    ...
    fprintf(fpasm, "\n\tcmp ebx, eax");
    fprintf(fpasm, "\n\tjle near is_less_equal_than_%d", etiqueta);

    fprintf(fpasm, "\n\tmov dword ebx, 0");
    fprintf(fpasm, "\n\tpush dword ebx");
    fprintf(fpasm, "\n\tjmp near next_is_less_equal_than_%d", etiqueta);

    fprintf(fpasm, "\nis_less_equal_than_%d:", etiqueta);
    fprintf(fpasm, "\n\tmov dword ebx,1");
    fprintf(fpasm, "\n\tpush dword ebx");

    fprintf(fpasm, "\nnext_is_less_equal_than_%d:", etiqueta);
}
...
void mayor_igual(FILE *fpasm, int es_variable1, int es_variable2, int etiqueta)
{
    ...
    fprintf(fpasm, "\n\tcmp ebx, eax");
    fprintf(fpasm, "\n\tjge near is_greater_equal_than_%d", etiqueta);

    fprintf(fpasm, "\n\tmov dword ebx, 0");
    fprintf(fpasm, "\n\tpush dword ebx");
    fprintf(fpasm, "\n\tjmp near next_is_greater_equal_than_%d", etiqueta);

    fprintf(fpasm, "\nis_greater_equal_than_%d:", etiqueta);
    fprintf(fpasm, "\n\tmov dword ebx,1");
    fprintf(fpasm, "\n\tpush dword ebx");

    fprintf(fpasm, "\nnext_is_greater_equal_than_%d:", etiqueta);
}
...
void menor(FILE *fpasm, int es_variable1, int es_variable2, int etiqueta)
{
    ...
    fprintf(fpasm, "\n\tcmp ebx, eax");
    fprintf(fpasm, "\n\tjl near is_less_than_%d", etiqueta);

    fprintf(fpasm, "\n\tmov dword ebx, 0");
    fprintf(fpasm, "\n\tpush dword ebx");
    fprintf(fpasm, "\n\tjmp near next_is_less_than_%d", etiqueta);

    fprintf(fpasm, "\n\tis_less_than_%d:", etiqueta);
    fprintf(fpasm, "\n\tmov dword ebx,1");
    fprintf(fpasm, "\n\tpush dword ebx");

    fprintf(fpasm, "\nnext_is_less_than_%d:", etiqueta);
}
...
void mayor(FILE *fpasm, int es_variable1, int es_variable2, int etiqueta)
{
    ...
    fprintf(fpasm, "\n\tcmp ebx, eax");
    fprintf(fpasm, "\n\tjg near is_greater_than_%d", etiqueta);

    fprintf(fpasm, "\n\tmov dword ebx, 0");
    fprintf(fpasm, "\n\tpush dword ebx");
    fprintf(fpasm, "\n\tjmp near next_is_greater_than_%d", etiqueta);

    fprintf(fpasm, "\n\tis_greater_than_%d:", etiqueta);
    fprintf(fpasm, "\n\tmov dword ebx,1");
    fprintf(fpasm, "\n\tpush dword ebx");

    fprintf(fpasm, "\nnext_is_greater_than_%d:", etiqueta);
}
...
void ifthenelse_inicio(FILE *fpasm, int exp_es_variable, int etiqueta)
{
    ...
    fprintf(fpasm, "\n\tcmp eax, 0");
    fprintf(fpasm, "\n\tje near _end_simple_conditional_%d", etiqueta);
...
void ifthen_fin(FILE *fpasm, int etiqueta)
{
    ...
    fprintf(fpasm, "\n_end_simple_conditional_%d:", etiqueta);
...
void ifthenelse_fin_then(FILE *fpasm, int etiqueta)
{
    ...
    fprintf(fpasm, "\n\tjmp near _end_compound_conditional_%d", etiqueta);
    fprintf(fpasm, "\n_end_simple_conditional_%d:", etiqueta);
...
void ifthenelse_fin(FILE *fpasm, int etiqueta)
{
    ...
    fprintf(fpasm, "\n_end_compound_conditional_%d:", etiqueta);
    return;
}
/*
...
void while_fin(FILE *fpasm, int etiqueta)
{
    ...
    fprintf(fpasm, "\n\tjmp near _start_loop_%d", etiqueta);
    fprintf(fpasm, "\n_end_loop_%d:", etiqueta);

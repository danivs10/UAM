...
%left TOK_NOT MENOSU
%left TOK_CORCHETEIZQUIERDO TOK_CORCHETEDERECHO TOK_PARENTESISIZQUIERDO TOK_PARENTESISDERECHO
...
funcion: TOK_FUNCTION tipo identificador TOK_PARENTESISIZQUIERDO parametros_funcion TOK_PARENTESISDERECHO TOK_LLAVEIZQUIERDA declaraciones_funcion sentencias TOK_LLAVEIZQUIERDA {fprintf(yyout, ";R22:\n<funcion> ::= function <tipo> <identificador> ( <parametros_funcion> ) { <declaraciones_funcion> <sentencias> }\n");};

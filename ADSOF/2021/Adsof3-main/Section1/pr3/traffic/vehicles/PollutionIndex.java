...
public enum PollutionIndex {
	...
	/**
	 * @return If the year is after or equal to 2018 it returns an A pollutionIndex,
	 *         if it's earlier than 2018 but after 2010 it returns B pollutionIndex
	 *         and if it's earlier than 2010 it returns C.

...
/**
* @brief Gets the id of the predecessor of a given node 
* @param n Node adress
* @return returns the id of the predecessor, or -1 in case of error
*/ 
...
/**
* @brief Modifies the Id of the predecessor of a given node
* @param n Node address
* @param predid Id of the predecessor Node
* @return  Returns OK or ERROR in case of error
*/
